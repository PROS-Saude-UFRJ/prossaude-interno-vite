import { entryEl } from "../../../src/lib/global/declarations/types";
import { handleLinkChanges } from "../../../src/lib/global/handlers/gRoutingHandlers";
import { assignFormAttrs, parseNotNaN } from "../../../src/lib/global/gModel";
...
import { elementNotFound, extLine, inputNotFound, maxNumberError } from "../../../src/lib/global/handlers/errorHandler";
import { handleCondtReq, syncAriaStates } from "../../../src/lib/global/handlers/gHandlers";
import { addListenerInnerTabs, validateTitlesForTargs } from "../../../src/lib/locals/edFisNutPage/edFisNutController";
