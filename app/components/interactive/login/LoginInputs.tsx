...
export default function LoginInputs(): JSX.Element {
  ...
  useEffect(() => assignFormAttrs(formRef.current ?? document.querySelector("form")));
  useEffect(() => {
    ...
    <form
      ...
      <div role='group' id='loginCont'>
        ...
        <section id='inputCont'>
          ...
          <nav id='loginBtnCont'>
            <a id='recover' className='fade-in-late-element' href='/recover' rel='nofollow noreferrer' target='_self'>
              Esqueci minha senha
            </a>
            <button
              type='submit'
